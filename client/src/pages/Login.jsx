            ...
            <form onSubmit={onSubmitHandler}>
               ...
               (<div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                    ...
                    <input 
                        ...
                        className="bg-transparent outline-none w-99" 
                    />
                </div>)
                }
                <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                    ...
                    <input 
                        ...
                        value={email} type="email" name="" id="" 
                ...
                <button className="w-full py-2 5 rounded-full bg-linear-to-r from-indigo-900 text-white font-medium">
                    {state}
                </button>
            </form>
