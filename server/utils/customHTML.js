export const mailHTML = `
            ...
            <head>
                ...
                <title>Welcome To Astrolab</title>
                ...
                <style type="text/css">
                    ...
                    /* Custom styles */
                    body { margin: 0; padding: 0; background-color: #f44a4aff; }
            ...
            <body style="margin: 0; padding: 0; background-color: #f44a4aff; font-family: 'Inter', sans-serif;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="full-width-mobile" style="max-width: 600px;">
                            ...
                            <tr>
                                <td align="center" style="padding: 20px 0 30px 0;">
                                    ...
                                    <h1 style="margin: 0; color: #b91010ff; font-size: 32px; font-weight: 700;">
                                        Astrolab
                                    </h1>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td bgcolor="#ffffff" style="padding: 30px 40px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.06);">
                                    ...
                                    <!-- Greeting -->
                                    <h2 class="header-text" style="color: #1f2937; font-size: 28px; margin: 0 0 15px 0; font-weight: 600;">
                                        Welcome, [User Name]!
                                    </h2>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 25px;">
                                        <tr>
                                            <td align="center" bgcolor="#b91035ff" style="border-radius: 8px;">
                                                <a href="[Verification/Dashboard Link]" target="_blank" style="font-size: 16px; font-weight: bold; font-family: 'Inter', sans-serif; color: #ffffff; text-decoration: none; padding: 12px 25px; border-radius: 8px; border: 1px solid #10b981; display: inline-block;">
                                                    Get Started Now
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td align="center" style="padding: 30px 20px 0 20px;">
                                    ...
                                    <p style="color: #9ca3af; font-size: 12px; margin: 0;">
                                        [Your Company Name] | 123 Main Street, City, Country
                                    </p>
                                </td>
                            </tr>
